...
class __TwigTemplate_d216ee603bb91cb33b2b4d1195c04cae745fb799c2a97c7db5586e1d14a3aaaa extends Twig_Template
{
    ...
    ";
       ...
       .gmaps{
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["lugares"]) ? $context["lugares"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["results"]) {
            // line 81
            echo "
                <div class=\"col-md-7\"><h3>";
            // line 82
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["results"]) ? $context["results"] : null), "name"), "html", null, true);
            echo "</h3></div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
            ...
            echo "                <div class=\"actividad col-md-10\">   
                    ...
                    ";
            // line 94
            if (($this->getAttribute((isset($context["result"]) ? $context["result"] : null), "getGaleryLength") >= 1)) {
                // line 95
                echo "                                    ";
                if ($this->getAttribute((isset($context["result"]) ? $context["result"] : null), "getGalery")) {
                    echo "    
                            <img src=\"";
                    // line 96
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["result"]) ? $context["result"] : null), "getFoto"), "getWebPathFile"), "html", null, true);
                    echo "\" alt=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["result"]) ? $context["result"] : null), "getName"), "html", null, true);
                    ...
                    echo "                                            ";
                    $context['_parent'] = (array) $context;
                    $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["result"]) ? $context["result"] : null), "getGalery"));
                    foreach ($context['_seq'] as $context["_key"] => $context["imagen"]) {
                        // line 99
                        echo "                            <nav>
                                <img src=\"";
                        // line 100
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["imagen"]) ? $context["imagen"] : null), "getWebPathFile"), "html", null, true);
                        echo "\" alt=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["result"]) ? $context["result"] : null), "getName"), "html", null, true);
                        echo "\" class=\"img-responsive\"/>
                            </nav>                                        
            ...
            echo "
                        ...
                        <div class=\"col-md-7\"><h3>";
            // line 107
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["result"]) ? $context["result"] : null), "name"), "html", null, true);
            echo "</h3><p>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["result"]) ? $context["result"] : null), "description"), "html", null, true);
            echo "</p><br>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["result"]) ? $context["result"] : null), "cost"), "html", null, true);
            echo " <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("front_frontend_actividad_detalle", array("id" => $this->getAttribute((isset($context["result"]) ? $context["result"] : null), "getId"))), "html", null, true);
