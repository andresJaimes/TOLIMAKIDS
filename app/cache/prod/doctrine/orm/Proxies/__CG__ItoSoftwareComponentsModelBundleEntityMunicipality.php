 ...
 */
class Municipality extends \ItoSoftware\Components\ModelBundle\Entity\Municipality implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Municipality $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addplaces(\ItoSoftware\Components\ModelBundle\Entity\Places $places)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addplaces', array($places));

        return parent::addplaces($places);
    }

    /**
     * {@inheritDoc}
     */
    public function removePlaces(\ItoSoftware\Components\ModelBundle\Entity\Places $places)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePlaces', array($places));

        return parent::removePlaces($places);
    }
