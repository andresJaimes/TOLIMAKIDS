 ...
 */
class Places extends \ItoSoftware\Components\ModelBundle\Entity\Places implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'name', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'address', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'description', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'latitude', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'length', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'id', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'municipality', '' . "\0" . 'ItoSoftware\\Components\\ModelBundle\\Entity\\Places' . "\0" . 'activity');
        }
     ...
     * {@inheritDoc}
     */
    public function validateActivity(\Symfony\Component\Validator\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'validateActivity', array($context));

        return parent::validateActivity($context);
    }
    ...
    public function setMunicipality(\ItoSoftware\Components\ModelBundle\Entity\Municipality $municipality = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMunicipality', array($municipality));
    ...
    public function getMunicipality()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMunicipality', array());
