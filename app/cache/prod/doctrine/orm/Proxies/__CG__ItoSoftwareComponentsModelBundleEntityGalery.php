 ...
 */
class Galery extends \ItoSoftware\Components\ModelBundle\Entity\Galery implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Galery $proxy) {
    ...
    public function getWebPathFile()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWebPathFile', array());

        return parent::getWebPathFile();
    }
    ...
    public function uploadFile($file)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'uploadFile', array($file));
