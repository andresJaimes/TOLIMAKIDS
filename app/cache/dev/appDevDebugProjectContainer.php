...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.usuario' => 'getSecurity_Firewall_Map_Context_UsuarioService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/Tolima_Kids/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/Tolima_Kids/app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Tolima_Kids', 'user' => 'root', 'password' => '14142135', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_df90c1afb9a294c1dec049b6477d35ea');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_df90c1afb9a294c1dec049b6477d35ea');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_df90c1afb9a294c1dec049b6477d35ea');
        ...
        $f->setProxyDir('/home/Tolima_Kids/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'ito_admin.admin.ito_group' service.
     *
     * @return ItoSoftware\Components\AdminBundle\Admin\ItoGroupAdmin A ItoSoftware\Components\AdminBundle\Admin\ItoGroupAdmin instance.
     */
    ...
    /**
     * Gets the 'ito_admin.admin.ito_user' service.
     *
     * @return ItoSoftware\Components\AdminBundle\Admin\ItoUserAdmin A ItoSoftware\Components\AdminBundle\Admin\ItoUserAdmin instance.
     */
    ...
    /**
     * Gets the 'logout_admin_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ItoSoftware\Components\UserBundle\Handler\LogoutHandler A ItoSoftware\Components\UserBundle\Handler\LogoutHandler instance.
     */
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/Tolima_Kids/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'my.oauth_aware.user_provider.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ItoSoftware\Components\UserBundle\Security\Core\User\FOSUBUserProvider A ItoSoftware\Components\UserBundle\Security\Core\User\FOSUBUserProvider instance.
     */
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/Tolima_Kids/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/Tolima_Kids/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/Tolima_Kids/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $j, 3 => $l, 4 => $n, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $i, $f, $c, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '53b6dfc88d715', $c), 7 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $a, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $a, '/loginface', false), NULL, NULL, $c));
    }

    /**
     * Gets the 'security.firewall.map.context.usuario' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_UsuarioService()
    {
        ...
        $e = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $e->addHandler($this->get('security.logout.handler.session'));

        $f = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($a, array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $f->setProviderKey('usuario');

        return $this->services['security.firewall.map.context.usuario'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $e, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $a, 'usuario', $f, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($c, $a, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $d), array('use_forward' => false, 'check_path' => '/index/login_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $d, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'usuario', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'fos_user_security_login', false), NULL, NULL, $d));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/Tolima_Kids/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/Tolima_Kids/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/Tolima_Kids/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/Tolima_Kids/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'sonata.activity.admin.activity' service.
     *
     * @return ItoSoftware\Components\AdminBundle\Admin\ActivityAdmin A ItoSoftware\Components\AdminBundle\Admin\ActivityAdmin instance.
     */
    ...
    /**
     * Gets the 'sonata.galery.admin.galery' service.
     *
     * @return ItoSoftware\Components\AdminBundle\Admin\GaleryAdmin A ItoSoftware\Components\AdminBundle\Admin\GaleryAdmin instance.
     */
    ...
    /**
     * Gets the 'sonata.municipality.admin.municipality' service.
     *
     * @return ItoSoftware\Components\AdminBundle\Admin\MunicipalityAdmin A ItoSoftware\Components\AdminBundle\Admin\MunicipalityAdmin instance.
     */
    ...
    /**
     * Gets the 'sonata.places.admin' service.
     *
     * @return ItoSoftware\Components\AdminBundle\Admin\PlacesAdmin A ItoSoftware\Components\AdminBundle\Admin\PlacesAdmin instance.
     */
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('usuario', 'fos_user_security_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/Tolima_Kids/app/cache/dev/translations', 'debug' => true));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/Tolima_Kids/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/Tolima_Kids/vendor/knplabs/knp-paginator-bundle/Knp/Bundle/PaginatorBundle/Resources/views', 'KnpPaginator');
        ...
        $instance->addPath('/home/Tolima_Kids/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/Tolima_Kids/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/Tolima_Kids/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/Tolima_Kids/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSonata_Block_ManagerService()
    {
        ...
        $instance->add('sonata.block.service.text', 'sonata.block.service.text', array(0 => 'ito_base_s2'));
        $instance->add('sonata.block.service.rss', 'sonata.block.service.rss', array(0 => 'ito_base_s2'));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/Tolima_Kids/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/Tolima_Kids/app/cache/dev',
            ...
            'debug.container.dump' => '/home/Tolima_Kids/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/Tolima_Kids/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/Tolima_Kids/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/Tolima_Kids/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/Tolima_Kids/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'assetic.cache_dir' => '/home/Tolima_Kids/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/Tolima_Kids/app/cache/dev/doctrine/orm/Proxies',
